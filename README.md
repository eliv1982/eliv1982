...
- AI-надстройка для более понятных формулировок;
- Telegram-интерфейс для взаимодействия с пользователем.

**Бизнес-польза:**

- помогает пользователю быстро получить погодную информацию;
- снижает количество ручных запросов к менеджеру или оператору;
...
**Tech stack:** Python, Telegram Bot API, PostgreSQL, SQL, OpenAI API, weather API, caching, Git.

Repository:  
[weather_teller_bot](https://github.com/eliv1982/weather_teller_bot)

---

### 💬 Customer Review AI Assistant

AI-ассистент для анализа клиентских отзывов и подготовки черновиков ответов.
...
- краткая сводка по отзыву;
- генерация черновика ответа клиенту;
- сохранение результатов;
- тестирование ключевой логики проекта.

**Бизнес-польза:**

- снижает ручную нагрузку на поддержку;
- помогает быстрее реагировать на негативные отзывы;
- структурирует клиентскую коммуникацию;
- может использоваться как основа для внутреннего AI-инструмента поддержки.

**Tech stack:** Python, OpenAI API, Prompt Engineering, SQLite, CSV, Telegram Bot API, pytest, Git.

Repository:  
[customer-review-ai-assistant](https://github.com/eliv1982/customer-review-ai-assistant)
...
- генерация ответа на основе найденных материалов;
...
- помогает быстрее ориентироваться в большом объёме правовой информации;
- снижает ручную нагрузку при работе с документами;
- может использоваться как прототип внутреннего юридического AI-ассистента;
- подходит для задач, где важна точность, структура и работа с источниками.

**Tech stack:** Python, OpenAI API, RAG, ChromaDB, SQLite, Prompt Engineering, Git.

Repository:  
[rag-assistant-independent-guarantees](https://github.com/eliv1982/rag-assistant-independent-guarantees)

---

### 💱 Currency Travel Bot

Telegram-бот для работы с валютами и travel-сценариями.

**Что реализовано:**

- получение курсов валют;
- конвертация валют;
- сравнение выбранных валют;
- поддержка популярных валют для путешествий;
- простой Telegram-интерфейс.

**Бизнес-польза:**

- помогает пользователю быстро получать валютную информацию;
- может быть основой для travel-бота или финансового помощника;
- показывает работу с API и пользовательскими сценариями в Telegram.

**Tech stack:** Python, Telegram Bot API, currency API, JSON, Git.

Repository:  
[currency-travel-bot](https://github.com/eliv1982/currency-travel-bot)
